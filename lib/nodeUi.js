...
module.exports = {
    ...
    /**
     * @param {"button" | "textbox" | "checkbox" | "label" | "combobox" | "listbox"} tag - The type of element this function should create. https://github.com/RickLugtigheid/Node-Ui/wiki/Elements#tags
    ...
    createElement(tag, callback, ...options){
        ...
        switch(tag){
            ...
            case 'textbox':
                ...
                return new texbox(tag, [x, y], [null, width], [hidden], callback);
            case 'listbox':
...
function isElement(check){
    if(check && check['tag']) return true;
    return false;
}
